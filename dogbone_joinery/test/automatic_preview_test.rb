    ...
    module DogboneJoinery
      class AutomaticPreviewTest < Minitest::Test
        ...
        def test_compact_dialog_has_only_bulk_controls_and_summary
          ...
          assert_includes html, 'id="diagnosticDetails"'
          assert_includes html, 'Chi tiết chẩn đoán'
          ...
          assert_includes javascript, 'diagnostic_id'
          assert_includes javascript, 'diagnostic_detail'
          assert_includes javascript, 'diagnostic_log_path'
